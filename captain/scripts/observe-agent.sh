...
#
# Usage:
#   captain/scripts/observe-agent.sh --latest
#   captain/scripts/observe-agent.sh --file /path/to/transcript.jsonl
#   captain/scripts/observe-agent.sh --all
#   captain/scripts/observe-agent.sh --latest --kb-root "$HOME/.openclaw/workspace/captain/captain/knowledge"
