...
- `risky-change-caught.sh` demonstrates the policy/eval framing for unsafe or low-quality changes.

Set `TARGET_REPO` to the repository you want Captain to govern.
