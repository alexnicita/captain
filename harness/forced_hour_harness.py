...
Usage examples:
  python3 harness/forced_hour_harness.py run --checklist harness/checklist.md
  python3 harness/forced_hour_harness.py status
  python3 harness/forced_hour_harness.py stop
  python3 harness/forced_hour_harness.py run --checklist harness/checklist.md --dry-run
"""
